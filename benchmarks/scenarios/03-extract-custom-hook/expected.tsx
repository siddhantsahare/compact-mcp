...
function useSearch(initialCategory: Category = 'all') {
  const [query, setQueryRaw] = useState('');
  const [category, setCategoryRaw] = useState<Category>(initialCategory);
  ...
  return { query, category, results, loading, error, page, setQuery, setCategory, setPage };
}

export function SearchPage() {
  const { query, category, results, loading, error, page, setQuery, setCategory, setPage } =
    useSearch();
